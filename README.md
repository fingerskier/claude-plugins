...
|--------|-------------|---------|
| [dex](https://github.com/fingerskier/dex-claude-plugin) | Scheduler — run jobs in Claude on a cron schedule | `claude plugin install dex-claude-plugin@fingerskier-plugins` |
