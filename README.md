...
| [council](https://github.com/fingerskier/council-ai-plugin) | Convene a council of personality seats — an interactive meeting or autonomous work session — while a chair routes and synthesizes. Dual-hosted for Claude Code and Codex | `claude plugin install council@fingerskier-plugins` |
| [introspector](https://github.com/fingerskier/introspector) | Build a mindmap and guided tour of a repo or document set — a Mermaid mindmap of concepts/modules plus a guided reading tour | `claude plugin install introspector@fingerskier-plugins` |
| [kicad_buddy](https://github.com/fingerskier/kicad_buddy) | KiCad MCP service — BOM, netlist, Gerbers, DRC/ERC, 2D plots, 3D models, footprints, and symbols via KiCad's IPC API and kicad-cli | `claude plugin install kicad_buddy@fingerskier-plugins` |
